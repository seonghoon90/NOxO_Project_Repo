      ...
      <div className="content-inner">
        <section className="hero-grid">
          <div>
            ...
            <p className="hero-copy">
              합성가스 발전소의 NOx는 한 번의 조작에 즉시 반응하지 않습니다. 운영자는 지금 누르면 잠시 후 어떻게 될지를
        ...
        <section className="content-section">
          ...
          <p className="body-copy">
            ...
            멈추고, 보고서가 쌓이고, 다음 분기 운영 계획이 흔들립니다. 그래서 관제실의 운영자는 합성가스 유량·IGV
            개도·희석질소까지 10개의 제어 변수를 동시에 들여다보며 NOx를 누르고 있습니다.
          </p>
          <p className="body-copy">
            문제는 NOx가 조작 직후에 보이지 않는다는 점입니다. 변수를 바꾼 결과는 한참 뒤에야 화면에 나타나고,
            그때는 이미 손쓰기 늦은 경우가 많았습니다. 운영자에게 필요한 것은 기다림이 아니라 미리 보기였습니다.
          </p>
        ...
        <section className="content-section">
          ...
          <p className="body-copy">
            ...
            제어 변수 중 하나를 조작하면, NOx·배기온도·발전량이 함께 움직이며 새 정상상태로 수렴해 갑니다. 한 번의
            조작이 만들어내는 전체 응답 곡선을 운영자가 그대로 관찰할 수 있습니다.
          </p>
          <p className="body-copy">
        ...
        <section className="content-section">
          ...
          <p className="body-copy">
            시뮬레이션이 조작의 결과를 보여준다면, 5분 후 예측은 조작이 없을 때의 자연 추이를 보여줍니다. 현재 센서
            시계열을 바탕으로 5분 뒤 NOx를 미리 추정해, 운영자가 상승 위험을 사전에 감지할 수 있게 합니다.
          </p>
        </section>
      </div>
    </main>
